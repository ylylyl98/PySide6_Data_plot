...
class MenuToolbarHost:
    ...
    def __init__(
        ...
        *,
        ...
        self.load_action = QAction("Reload", window)
        self.load_action.setToolTip("Reload data for the active tab")
        self.plot_action = QAction("Update now", window)
        self.plot_action.setToolTip("Update the current plot")
